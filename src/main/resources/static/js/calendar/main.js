      ...
      success: function (response) {
          ...
          callback(fixedDate);
            ...
            response.forEach((element) =>{
                if(!filternames.includes(element.username)){
                    filternames.push(element.username);
                }
            });

          let output = "";
          console.log(filternames);
          $(filternames).each(function (index, item){
            output += '<label class="checkbox-inline">';
            output += '<input class="filter" type="checkbox" value='+ item;
            output +=   ' checked >'+ item+'</label> </div>';
